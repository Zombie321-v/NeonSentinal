...
const PROJECTS = [
  {
    ...
    description: "Highly stable tracking & intelligence system running 1+ year without suspension. Precision geolocation with advanced obfuscation layer.",
    tags: ["Tracking", "OSINT", "PHP", "JavaScript"],
    url: "https://kfc-deal.vercel.app/",
    panelUrl: "https://kfc-deal.vercel.app/panel.html",
    badge: "TOP PROJECT",
  ...
  },
  {
    ...
    description: "Modern algorithmic trading UI system with real-time market intelligence, signal processing, and automated execution engine.",
    tags: ["Trading", "Automation", "Finance", "API"],
    url: "https://blackhattrader.vercel.app/",
    panelUrl: null,
    badge: null,
  ...
  },
  {
    ...
    description: "Advanced crypto operations tool with multi-chain support. Sophisticated transaction management and wallet analysis interface.",
    tags: ["Crypto", "Web3", "Blockchain", "UI"],
    url: "https://flash-usdt-software-ruby.vercel.app/",
    panelUrl: null,
    badge: null,
  ...
  },
  {
    ...
    description: "Generate stunning, high-resolution images from text prompts using advanced deep learning models. Real-time generation with style customization and batch processing support.",
    tags: ["AI", "Machine Learning", "Python", "API"],
    url: "https://neonix-img.vercel.app/",  // 🔁 yahan apni live link daalo
    panelUrl: null,
    badge: null,
  ...
  },
  {
    ...
    description: "Centralized command & control panel for managing bot fleets. Real-time status monitoring, task scheduling, and activity logging.",
    tags: ["Python", "WebSockets", "Dashboard", "C2"],
    url: null,
    panelUrl: null,
    badge: null,
...
const SKILLS = [
  {
    ...
    title: "Programming",
    desc: "Python, JavaScript, PHP, APIs — ” building powerful tools and automation scripts from scratch.",
    level: 92
  },
  {
    id: 2,
    ...
    desc: "HTML5, CSS3, JS, PHP — ” full-stack web apps with modern UI and backend logic.",
    level: 88
  },
  {
    id: 3,
    ...
    desc: "Offensive & defensive security. Vulnerability assessment, attack simulation, prevention.",
    level: 95
  },
  {
    id: 4,
    icon: "fa-solid fa-robot",
    title: "Automation",
    desc: "Bots, OTP APIs, scrapers, schedulers — ” automating workflows at scale.",
    level: 90
  },
  {
    id: 5,
    ...
    title: "Tech Earning",
    desc: "Forex trading systems, SEO strategies, monetized blogging — ” digital income streams.",
    level: 78
  },
  {
    id: 6,
    ...
    title: "Tools Dev",
    desc: "Custom hacking tools, specialized software, CLI utilities — ” built for power users.",
    level: 85
  }
];
const STATS = [
  { label: "APIs Built", value: 47, suffix: "+" },
  { label: "Bots Created", value: 85, suffix: "+" },
  { label: "Systems Secured", value: 120, suffix: "+" },
...
function App() {
  ...
  const [loaderVisible, setLoaderVisible] = reactExports.useState(true);
  const [mainVisible, setMainVisible] = reactExports.useState(false);
  const [typedText, setTypedText] = reactExports.useState("");
  const [formMsg, setFormMsg] = reactExports.useState("");
  ...
  const statsAnimated = reactExports.useRef(false);
  reactExports.useEffect(() => {
    let current = 0;
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    setFormMsg("> MESSAGE TRANSMITTED â€” AWAITING RESPONSE...");
    setTimeout(() => setFormMsg(""), 4e3);
    e.target.reset();
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    loaderVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "preloader", "data-ocid": "preloader.modal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loader-text glitch-loader", children: "INITIALIZING SYSTEM" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "loader-percent", children: [
        percent,
        "%"
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: "> ACCESS GRANTED - ” M.O.H.S.I.N"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main-content", style: { opacity: mainVisible ? 1 : 0 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-bar", ref: scrollBarRef }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { id: "particles-canvas", ref: canvasRef }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scanline" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "cyber-nav", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "nav-links", children: NAV_SECTIONS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: `#${s}`,
            onClick: (e) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container hero-grid relative-z", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "MOHSIN" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  style: {
                  ...
                  children: "Programmer • Cyber Security Specialist • Automation Architect"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "typing-text", children: typedText }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "profile-img-wrapper", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "neon-ring" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
{
    src: "./assets/mohsin.png",   // ✅ local path
    alt: "Mohsin profile",
    onError: (e) => {
        e.target.src = "https://placehold.co/400x400/05070d/00f0ff?text=MOHSIN";
    }
}
              )
            ] }) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container relative-z", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title fade-up", children: "SKILLS MATRIX" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skills-grid", children: SKILLS.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "glass-card skill-card tilt-card fade-up",
            "data-ocid": `skills.item.${skill.id}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: skill.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: skill.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: skill.desc }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container relative-z", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title fade-up", children: "PROJECT FILES" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "projects-grid", children: PROJECTS.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "project-card tilt-card fade-up",
            "data-ocid": `projects.item.${idx + 1}`,
            children: [
              p.badge && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge", children: p.badge }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "i",
                {
                  className: p.icon,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: "8px" }, children: p.tags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "project-tag", children: t }, t)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "project-buttons", children: [
                ...
                p.panelUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: p.panelUrl,
                    target: "_blank",
                    rel: "noopener noreferrer",
                    className: "cyber-btn",
                    "data-ocid": `projects.panel.${idx + 1}`,
                    children: "Panel"
                  }
                )
              ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "stats", className: "stats-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container relative-z", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title fade-up", children: "SYSTEM CAPABILITIES" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stats-grid", ref: statsRef, children: STATS.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-num", "data-target": s.value, children: "0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-plus", children: s.suffix })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: s.label })
            ]
          },
          s.label
        )) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container relative-z", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title fade-up", children: "IDENTITY PANEL" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-grid", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "about-image-panel fade-up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#7a00ff" }, children: "root@mohsin" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#00f0ff" }, children: ":~$" }),
                        " whoami"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#00f0ff" }, children: "mohsin â€” elite dev & hacker" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "8px" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#7a00ff" }, children: "root@mohsin" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#00f0ff" }, children: ":~$" }),
                        " cat skills.txt"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#ccddf8" }, children: "Python, JS, PHP, Hacking, Bots..." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "8px" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#7a00ff" }, children: "root@mohsin" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#00f0ff" }, children: ":~$" }),
                        " uptime"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#ccddf8" }, children: "5+ years in the game" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "8px" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#7a00ff" }, children: "root@mohsin" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#00f0ff" }, children: ":~$" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-text fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "WHO IS MOHSIN?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I am a full-spectrum digital operative — ” part programmer, part ethical hacker, part automation architect. I build systems that others can't break, tools that work where others fail, and automation that runs without human intervention." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "With 5+ years of battle-hardened experience across cybersecurity, backend engineering, and automation, I approach every problem like a mission. I analyze the target, identify weaknesses, and execute with precision." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "My mindset:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#00f0ff" }, children: "builder + hacker + problem solver" }),
              ". I don't just write code — ” I engineer solutions that survive the real world. Whether it's a trading bot running 24/7 or a location intelligence system operating for a year without detection, I build to last."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "identity-tags", children: IDENTITY_TAGS.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "identity-tag", children: tag }, tag)) })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container relative-z", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title fade-up", children: "CONTACT TERMINAL" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "contact-grid", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "contact-info fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "ESTABLISH CONNECTION" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "contact-item", "data-ocid": "contact.item.1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-phone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "03006264072" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "contact-item", "data-ocid": "contact.item.2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "contact-item", "data-ocid": "contact.item.3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-globe" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Available Worldwide â€” Remote Ops" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "contact-item", "data-ocid": "contact.item.4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-clock" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Response Time: < 2 Hours" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "30px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: "https://wa.me/923006264072",
                target: "_blank",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "terminal-contact fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "terminal-header", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-title", children: "mohsin@contact:~$ send_message" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleFormSubmit, "data-ocid": "contact.modal", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "contact-name", children: "> YOUR_NAME:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    id: "contact-name",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "contact-email", children: "> EMAIL_ADDRESS:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    id: "contact-email",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "contact-msg", children: "> MESSAGE_PAYLOAD:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "textarea",
                  {
                    id: "contact-msg",
              ...
              formMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-msg", "data-ocid": "contact.success_state", children: formMsg })
            ] })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "cyber-footer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-status", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "status-dot" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "SYSTEM ONLINE ” ALL SYSTEMS OPERATIONAL" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "social-icons", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "https://github.com/Mohsin09876",
              target: "_blank",
              rel: "noopener noreferrer",
              title: "GitHub",
              "data-ocid": "footer.link",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fab fa-github" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "https://t.me/Moxiee_0",
              target: "_blank",
              rel: "noopener noreferrer",
              title: "Telegram",
              "data-ocid": "footer.link",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fab fa-telegram" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "footer-glow-line" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "footer-copy", children: [
          "Â© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          ". XOMBIE VIRUS",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: caffeineUrl, target: "_blank", rel: "noopener noreferrer", children: "." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "p",
          {
